...
// Сколько процентов добавляется к здоровью героя за уровень игрока в битве
#define PERCENT_UP_HP			2
// Сколько процентов добавляется к урону героя за уровень игрока в битве
#define PERCENT_UP_DP			2

// Сколько процентов отнимается от здоровья героя за отрицательный уровень игрока в битве
#define PERCENT_DOWN_HP			3
// Сколько процентов отнимается от урона героя за отрицательный уровень игрока в битве
